package com.javademo.java8.data;
...
public class StudentDataBase {
    ...
    public static List<Student> getAllStudents(){
        ...
        Student student7 = new Student("Amelia",4,3.9,"male",22, Arrays.asList("swimming", "basketball","baseball","football"));
        Student student8 = new Student("Jacob",4,4.2,"male",22, Arrays.asList("swimming", "basketball","baseball","football"));
